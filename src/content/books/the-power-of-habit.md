...
2. **Experiment with rewards** — to find which reward is actually driving the craving, try different rewards and observe what you actually crave (e.g. is a biscuit break about sugar, or about socialising?)
3. **Isolate the cue** — analyse the cue by asking: what time is it? Where am I? What is my emotional state? Who else is around? What did I just do?
4. **Have a plan** — write an implementation intention: "When CUE occurs, I will perform ROUTINE in order to get REWARD."

<iframe src="/images/the-power-of-habit/habit-change-framework.html" width="100%" height="400" style="border:none; border-radius:16px; overflow:hidden; margin: 2rem 0; display:block;" loading="lazy" title="Habit Change Framework Infographic"></iframe>
...
<iframe src="/images/the-power-of-habit/keystone-habits.html" width="100%" height="420" style="border:none; border-radius:16px; overflow:hidden; margin: 2rem 0; display:block;" loading="lazy" title="Keystone Habits Ripple Effect Infographic"></iframe>
